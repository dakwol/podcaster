(function ( $ ) {
    ...
    function calcPos(apples, percent) {
        if(percent < 0) {
            ...
            var starting_degree = (parseInt(apples) / 100);
            var starting_radian = starting_degree;
            return starting_radian;
        } else {
            // Calculate ending position
            var ending_degree = ((parseInt(apples) + parseInt(percent)) / 100);
    ...
    function createCanvas(scope) {
        ...
        var starting_radian = calcPos(global_settings.starting_position, 0);
